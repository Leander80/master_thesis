...
\begin{frame}
    ...
    \begin{minipage}{0.39\textwidth}
        \begin{itemize}
            ...
            \item ~$270$ measured Nutrino Events per day
...
\begin{frame}
    ...
    \begin{minipage}{0.39\textwidth}
        \begin{itemize}
            ...
            \item Wilkes theorem: fit $\Chi^2$-distribution
        \end{itemize}
    \end{minipage}
\end{frame}
\begin{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        \item Current status: use NNMFit to include systematics
        \item Optimize binning and cuts
        \item Do burnsample analysis
        \item Unblind
    \end{itemize}
\end{frame}
\end{document}