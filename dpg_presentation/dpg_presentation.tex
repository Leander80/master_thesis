...
\begin{frame}
	...
	\begin{minipage}{0.39\textwidth}
		\begin{itemize}
			...
			\item SnowStorm Ensemble: Individual systematics sampledeach event
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.49\textwidth]{Plots/Discovery_Poisson}
...
\begin{frame}
	...
	\begin{itemize}
		\item Treat MC-estimate as parameter drawn from distribution
	\end{itemize}
\end{frame}
\begin{frame}
